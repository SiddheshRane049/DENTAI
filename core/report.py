...
def _build_footer(scan, styles):
    ...
    p2 = Paragraph(f'<b>Verified by:</b><br/><br/><br/>________________________<br/><font size="8">Dr. ________________<br/>Date: {timezone.now().strftime("%d/%m/%Y")}</font>', styles['RightSmall'])
